...
def falling_alarm(image, bbox):
    ...
    cv2.putText(image, 'Fall Detected', (11, 100), 0, 1, [0, 0, 2550], thickness=3, lineType=cv2.LINE_AA)
def get_pose_model():
...
if __name__ == '__main__':
    process_video('/Users/gusgoodman/Documents/V89/Material/Elder_dall.mp4')
